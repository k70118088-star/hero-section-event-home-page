...
const Eventbg = () => {
  return (
    <div className='flex justify-center items-center'>
        ...
        <div className="absolute inset-0 bg-[url(/assets/e17367a742c4a1c61951756ea6f76d0309c431af.jpg)] bg-no-repeat bg-center bg-cover h-93 " />
      <div className="absolute inset-0 bg-black/50 h-93  " />
