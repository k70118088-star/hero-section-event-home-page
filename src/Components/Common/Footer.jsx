        ...
        <div className="md:flex md:flex-row grid grid-flow-col grid-rows-2  gap-15">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-2">
              <img
                src="/assets/13a0b63a658e8c72ca05d48233a0d03fac8d8bbe.jpg"
                className="w-full h-16 object-cover"
              />
              <img
                src="/assets/4e798e608ea7d38bc5c8229a337b5611eabaa78c.jpg"
                className="w-full h-16 object-cover"
              />
              <img
                src="/assets/56196ce0de909be874c10cd08442a838b7a6a80c.jpg"
                className="w-full h-16 object-cover"
              />
              <img
                src="/assets/30ced4257b0cea26940633e4c1554f7758ba6150.jpg"
                className="w-full h-16 object-cover"
              />
              <img
                src="/assets/1116959749387a8bd68bcef66fe900b53209470c.jpg"
                className="w-full h-16 object-cover"
              />
