...
const Hero = () => {
  return (
    <div className="relative min-h-screen">
      <div className="absolute inset-0 bg-[url(src/assets/10878ab9e650c4ad78302034fdebefa96e166933.jpg)] bg-cover bg-center scale-x-[-1]" />
      <div className="absolute inset-0 bg-black/50" />

      <Navbar />

      <div className="relative max-w-330 mx-auto px-5 pt-24">
        <h1 className="font-bold text-white leading-[120%]
        ...
        <p className="mt-6 text-white opacity-90
...
const Divider = () => (
  <span className="hidden lg:block w-0.75 h-18 bg-white" />
);
